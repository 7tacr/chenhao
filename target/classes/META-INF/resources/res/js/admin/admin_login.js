$(function () {
    ...
    $("#btn_login").click(function () {
        ...
        $.ajax({
            url: "/minghao/admin/login/doLogin",
            type: "post",
...
function initialCookie() {
    ...
    if (document.cookie.length > 0) {
        ...
        if (url !== null) {
            ...
            $("#div_background").css("background-image", "url(/minghao/res/images/admin/loginPage/background-4.jpg)");
        }
        if (username !== null) {
        ...
        $("#div_background").css("background-image", "url(/minghao/res/images/admin/loginPage/background-1.jpg)");
    }
}
...
function getUserProfilePicture(username) {
    if (username !== null && username !== "") {
        $.getJSON("/minghao/admin/login/profile_picture", {"username": username}, function (data) {
            if (data.success) {
                if (data.srcString !== null) {
                    $("#img_profile_picture").attr("src", "/minghao/res/images/item/adminProfilePicture/" + data.srcString);
                    return true;
                }
            }
        });
    }
    $("#img_profile_picture").attr("src", "/minghao/res/images/admin/loginPage/default_profile_picture-128x128.png");
}