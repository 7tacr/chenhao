...
<head>
    <script>
        $(function () {
            ...
            $(".details_picList").on("click", "li:not(.details_picList_fileUpload)", function () {
                ...
                if (productImage_id === "new") {
                    ...
                    $("#btn-ok").unbind("click").click(function () {
                        $.ajax({
                            url: "/minghao/admin/productImage/" + productImage_id,
                            type: "delete",
                            data: null,
        ...
        function uploadImage(fileDom) {
            ...
            //上传图片
            $.ajax({
                url: "/minghao/admin/uploadProductImage",
                type: "post",
                data: formData,
                contentType: false,
                processData: false,
...
<div class="details_div">
    ...
    <div class="frm_div">
        ...
        <input class="frm_input" id="input_product_title" type="text" maxlength="50"
               value="${requestScope.product.product_title}"/>
    </div>
    <div class="frm_div_last">
        ...
        <input class="frm_input details_unit" id="input_product_price" type="text" maxlength="10"
               value="${requestScope.product.product_price}"/>
        ...
        <input class="frm_input details_unit" id="input_product_sale_price" type="text" maxlength="10"
               value="${requestScope.product.product_sale_price}"/>
        <span class="details_unit text_info">元</span>
    </div>
</div>
<div class="details_div">
