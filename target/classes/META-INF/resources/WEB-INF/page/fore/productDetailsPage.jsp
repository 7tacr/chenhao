...
<head>
    ...
    <title>${requestScope.product.product_name}-tmall.com明昊土特产</title>
</head>
<body>
<nav>
    ...
    <div class="header">
        ...
        <span class="shopNameHeader">明昊${requestScope.product.product_category.category_name}官方旗舰店</span>
        ...
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 明昊土特产 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜明昊土特产" class="searchTmall">
                </div>
    ...
    <div class="loginDiv">
        ...
        <div class="qrcodeLogin">
            ...
            <div class="qrcodeFooter">
                ...
                <p>打开 <a href="https://www.tmall.com/wow/portal/act/app-download">手机明昊土特产</a> | <a
                        href="https://www.taobao.com/m">手机明昊</a>扫一扫登录</p>
            </div>
            <div class="loginLinks">
...
<div class="context">
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送明昊土特产积分<span><fmt:formatNumber type="number"
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.success) {
                                        ...
                                        if (data.url != null) {
                                            location.href = "/minghao" + data.url;
                                        } else {
                                            alert("加入购物车失败，请稍后再试！");
                                        }
                                    }
                ...
                <c:forEach items="${requestScope.loveProductList}" var="product">
                    <li class="context_ul_main">
                        <div class="context_ul_img">
                            <a href="/minghao/product/${product.product_id}">
