...
<head>
    ...
    <title>确认收货 - 明昊土特产-理想生活上明昊土特产</title>
    <script>
        ...
        <table class="table_order_orderItem">
            ...
            <tr>
                <td colspan="4">
                    ...
                    <span class="info_value">明昊模拟旗舰店</span>
                </td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <div class="bd">
                ...
                <script>
                    function confirmOrder() {
                        ...
                        if (yn) {
                            $.ajax({
                                url: "/minghao/order/success/${requestScope.productOrder.productOrder_code}",
                                type: "PUT",
                                data: null,
                                dataType: "json",
                                success: function (data) {
                                    if (data.success) {
                                        location.href = "/minghao/order/success/${requestScope.productOrder.productOrder_code}";
                                    } else {
                                        alert("订单确认异常，请稍后再试！");
