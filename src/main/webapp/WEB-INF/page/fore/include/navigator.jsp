    ...
    <div class="nav_main">
        ...
        <ul class="quick_li">
            <li class="quick_li_MyTaobao">
                <div class="sn_menu">
                    <a href="${pageContext.request.contextPath}/userDetails">我的购物<b></b></a>
            ...
            <%--                            <ul>--%>
            <%--                                <li><a href="">尚明昊土特产</a></li>--%>
            <%--                                <li><a href="">大牌街</a></li>--%>
            <%--                                <li><a href="">潮牌街</a></li>--%>
            <%--                                <li><a href="">明昊土特产原创</a></li>--%>
