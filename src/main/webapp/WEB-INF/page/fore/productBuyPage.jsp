...
<head>
    ...
    <title>确认订单 - Tmall.com明昊土特产-理想生活上明昊土特产</title>
    <script>
        $(function () {
            ...
            <c:forEach items="${requestScope.orderItemList}" var="orderItem" varStatus="i">
                <tr class="tr_shop">
                    <td><span class="span_shopTitle">店铺：</span><span
                            class="span_shopName">明昊${orderItem.productOrderItem_product.product_category.category_name}旗舰店</span>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
