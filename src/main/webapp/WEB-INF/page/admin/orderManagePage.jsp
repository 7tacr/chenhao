...
<head>
    <script>
        ...
        function parseOrderStatus(status) {
            ...
            return {"class": productOrderStatusClass, "title": productOrderStatusTitle, "status": productOrderStatus}
        }
                ...
                success: function (data) {
                    ...
                    if (data.productOrderList.length > 0) {
                        for (var i = 0; i < data.productOrderList.length; i++) {
                            ...
                            var productOrderStatusTitle;
                            var productOrderStatus;
                            let status = parseOrderStatus(data.productOrderList[i].productOrder_status);
                            productOrderStatusClass = status['class']
                            productOrderStatusTitle = status['title']
                            productOrderStatus = status['status']
