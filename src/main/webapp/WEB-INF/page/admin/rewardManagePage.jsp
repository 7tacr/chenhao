...
<div class="frm_div text_info">
    ...
    <div class="frm_group">
        ...
        <input id="checkbox_reward_isEnabled_special" name="checkbox_reward_isEnabled" type="checkbox" value="2"
               checked>
...
<div class="table_normal_div">
    <table class="table_normal" id="table_reward_list">
        ...
        <c:forEach items="${requestScope.rewardList}" var="reward">
            <tr>
                <td><input type="checkbox" class="cbx_select" id="cbx_reward_select_${reward.reward_id}"><label
                        for="cbx_reward_select_${reward.reward_id}"></label></td>
                ...
                <td>
                    <c:choose>
                        ...
                        <c:when test="${reward.reward_state==1}"><span class="td_success"
                                                                       title="打赏已审核">已审核</span></c:when>
