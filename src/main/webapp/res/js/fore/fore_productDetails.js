            ...
            if (data.success) {
                ...
                for (var i = 0; i < data.loveProductList.length; i++) {
                    ...
                    $(".context_ul_goodsList").children("ul").append("<li class='context_ul_main'><div class='context_ul_img'>" +
                        "<a href='/minghao/product/" + product_id + "'><img src='/minghao/res/images/item/productSinglePicture/" + src + "'/></a><p>¥" + product_sale_price + ".00</p></div></li>"
                    );
                }
            }
        }
